...
export const Spin = styled.div`
  ...
  & .spin-dot:nth-of-type(5) {
    animation-delay: -0.7s;
  }
  & .spin-dot:nth-of-type(6) {
  ...
  & .spin-dot:nth-of-type:before {
    animation-delay: -1.1s;
  }
  & .spin-dot:nth-of-type(2):before {
    animation-delay: -1s;
  }
  & .spin-dot:nth-of-type(3):before {
    animation-delay: -0.9s;
  }
  & .spin-dot:nth-of-type(4):before {
    animation-delay: -0.8s;
  }
  & .spin-dot:nth-of-type(5):before {
    animation-delay: -0.7s;
  }
  & .spin-dot:nth-of-type(6):before {
    animation-delay: -0.6s;
  }
`;
